...
export const SHORTCUT_ACTIONS = [
  ...
  { id: "openDashboard", label: "فتح لوحة التحكم", category: "التنقل", defaultKeys: "Ctrl+D", options: ["Ctrl+D", "Alt+D", "disabled"] },
...
export function getShortcutValue(settings, id) {
...
export function findShortcutConflict(shortcuts, actionId, value) {
...
export function getShortcutConflictDetails(shortcuts) {
  const conflicts = {};
