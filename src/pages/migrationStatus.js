...
export const LEGACY_PAGE_MIGRATION = {
  dashboard: { legacyComponentName: "", status: "native", notes: "Page JSX lives in src/pages/DashboardPage.jsx; shell, store, services, and vendor imports are native." },
  archive: { legacyComponentName: "", status: "native", notes: "Page JSX lives in src/pages/ArchivePage.jsx with native grid/list/table modes and a native file import wizard." },
  ...
  backup: { legacyComponentName: "", status: "native", notes: "Page JSX lives in src/pages/DataCenterPage.jsx; data operations use native storage, health, Excel, and portability services." },
  ...
  reports: { legacyComponentName: "", status: "native", notes: "Page JSX lives in src/pages/ReportsPage.jsx; export helpers use the explicit xlsx vendor module." },
  ...
  help: { legacyComponentName: "", status: "native", notes: "Page JSX lives in src/pages/HelpPage.jsx; shared UI wrappers and runtime bridges have been removed." }
};
