...
export function normalizeIconSpec(iconSpec, fallbackIcon = "📁") {
...
export function renderArchiveIcon(iconSpec, {
  fallbackIcon = "📁",
  color = "#10b981",
  className = "h-5 w-5",
  ...
  if (spec.type === "lucide") {
    ...
    return jsx(IconComponent, { className, style: { color: spec.color || color } });
  }
