...
// v2 (modern Linear/Vercel theme) is now the default for anyone who
// hasn't made an explicit choice. Users who previously picked "v1"
// via the Settings picker have an explicit localStorage key, so they
// keep classic; only those who never expressed a preference move to
// v2. Reverting is one click in Settings → المظهر → إصدار الواجهة.
export const DEFAULT_THEME_VERSION = "v2";
